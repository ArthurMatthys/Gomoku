...
mod tests {
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((7,5), TypeOfThreat::THREE_O, vec![(10,6),(10,8),(6,4)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((6,4), TypeOfThreat::THREE_O, vec![(10,6),(7,5)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((10,8), TypeOfThreat::THREE_O, vec![(10,6),(7,5),(11,9)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((11,9), TypeOfThreat::THREE_O, vec![(10,6),(10,8)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,6), TypeOfThreat::THREE_O, vec![(10,6),(10,8),(10,6),(9,9),(9,5)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,5), TypeOfThreat::THREE_O, vec![(10,8),(10,6),(9,6)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,9), TypeOfThreat::THREE_O, vec![(10,9),(10,6),(10,8),(9,6),(9,10)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,9), TypeOfThreat::THREE_O, vec![(10,9),(9,6),(9,10)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,9), TypeOfThreat::THREE_O, vec![(8,9),(9,6),(9,10)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,9), TypeOfThreat::THREE_O, vec![(7,9),(9,6),(9,10)])
    ...
    fn threat_connect_2_catch_extremity_hard1_0() {
        ...
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> = vec![
            ((9, 6), TypeOfThreat::THREE_O, vec![(9, 9), (9, 5)]),
            ((9, 5), TypeOfThreat::THREE_O, vec![(9, 6), (9, 9), (9, 4)]),
            ((9, 9), TypeOfThreat::THREE_O, vec![(7, 9), (9, 6), (9, 10)]), // (7,9) missing currently
            (
                (9, 10),
                TypeOfThreat::THREE_O,
                vec![(9, 9), (9, 6), (9, 11)],
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,9), TypeOfThreat::THREE_O, vec![(11,9),(9,6),(9,10)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((7,9), TypeOfThreat::THREE_O, vec![(7,8),(10,6),(6,10)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((6,10), TypeOfThreat::THREE_O, vec![(7,8),(7,9),(10,6),(5,11)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((10,6), TypeOfThreat::THREE_O, vec![(7,8),(7,9),(11,5)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((11,5), TypeOfThreat::THREE_O, vec![(7,8),(10,6),(7,9),(12,4)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,6), TypeOfThreat::THREE_O, vec![(7,8),(9,9),(9,5)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,5), TypeOfThreat::THREE_O, vec![(7,8),(9,6),(9,9),(9,4)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,9), TypeOfThreat::FOUR_SO, vec![(7,8),(9,10)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,12), TypeOfThreat::THREE_O, vec![(9,9),(9,13)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((3,6), TypeOfThreat::THREE_O, vec![(0,8),(0,9),(4,5)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,6), TypeOfThreat::THREE_O, vec![(0,8),(2,9),(2,5)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,5), TypeOfThreat::THREE_O, vec![(0,8),(2,6),(2,9),(2,4)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,3), TypeOfThreat::THREE_O, vec![(2,0),(2,4)])
    ...
    fn threat_connect_2_fake_catch_close_top_2_s0_4() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> = vec![
            ((3, 1), TypeOfThreat::FOUR_SO, vec![(3, 4)]),
            ((3, 4), TypeOfThreat::THREE_O, vec![(3, 1), (3, 5)]),
            ((3, 5), TypeOfThreat::THREE_O, vec![(3, 4), (3, 1), (3, 6)]),
        ];
        assert!(test_threat_2(
            white_pos,
            black_pos,
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,2), TypeOfThreat::THREE_O, vec![(2,5),(2,1)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,1), TypeOfThreat::THREE_O, vec![(0,1),(2,2),(2,5),(2,0)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,5), TypeOfThreat::THREE_O, vec![(2,2),(2,6)])
    ...
    fn threat_connect_4_fake_catch_9_in_a_row_other_close_top_3() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((2, 4), TypeOfThreat::THREE_TAKE, vec![])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
    ...
    fn threat_connect_4_fake_catch_9_in_a_row_other_close_top_four() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((2, 4), TypeOfThreat::FOUR_TAKE, vec![])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
    ...
    fn threat_connect_4_fake_catch_4_in_a_row_so() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((2, 6), TypeOfThreat::FIVE_TAKE, vec![])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
    ...
    fn threat_connect_4_diagonal_left_0() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((4, 4), TypeOfThreat::FIVE_TAKE, vec![])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
    ...
    fn threat_connect_4_fake_catch_close_top_2_SO_0() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((2, 0), TypeOfThreat::FIVE_TAKE, vec![(0, 0)])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
    ...
    fn threat_connect_4_diagonal_bottom_right_SO() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((14, 14), TypeOfThreat::FIVE_TAKE, vec![])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
    ...
    fn threat_connect_4_diagonal_up_right_SO() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((14, 4), TypeOfThreat::FIVE_TAKE, vec![])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
    ...
    fn threat_connect_4_diagonal_multiple_4_in_a_row_0() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((0, 0), TypeOfThreat::FIVE_TAKE, vec![])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
    ...
    fn threat_connect_4_diagonal_multiple_4_in_a_row_4() {
        ...
        let mut black_take = 0_isize;
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((1, 5), TypeOfThreat::FIVE_TAKE, vec![])];
        assert!(test_threat_4(
            white_pos,
            black_pos,
            &mut white_take,
