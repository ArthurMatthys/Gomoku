...
mod tests {
    ...
    fn threat_connect_2_catch_9_in_a_row_catch_1() {
        ...
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> = vec![
            ...
            (
                (11, 5),
                TypeOfThreat::ThreeOF,
                vec![(10, 6), (7, 9), (12, 4), (7, 8)],
            ),
            ((9, 6), TypeOfThreat::ThreeOC, vec![(9, 9), (9, 5), (7, 8)]),
            (
                (9, 5),
                TypeOfThreat::ThreeOF,
                vec![(9,6),(9,9),(9,4),(7,8)],
    ...
    fn threat_connect_2_catch_9_in_a_row_catch_3() {
        ...
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> =
            vec![((9, 9), TypeOfThreat::FourSOC, vec![(9, 11), (7, 8)])];
        assert!(test_threat_2(
            white_pos,
            black_pos,
            (9, 8),
    ...
    fn threat_connect_2_catch_9_in_a_row_catch_4() {
        ...
        let white_pos = vec![(10, 8), (9, 6)];
        let expected_result: Vec<((usize, usize), TypeOfThreat, Vec<(usize, usize)>)> = vec![
            ((9, 9), TypeOfThreat::FourSOF, vec![(9, 10), (7, 8)]),
            ((9, 10), TypeOfThreat::FourSOF, vec![(9, 9), (7, 8)]),
        ];
        assert!(test_threat_2(
            white_pos,
            black_pos,
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,4), TypeOfThreat::FiveTake, vec![(10,4),(10,6),(10,8)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((9,9), TypeOfThreat::FiveTake, vec![(10,9),(10,8),(10,6)])
    #[test]
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,9), TypeOfThreat::FiveTake, vec![(0,9)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,4), TypeOfThreat::FiveTake, vec![(0,7),(0,6),(0,8),(0,10)])
    ...
    // ___________________
    // DEFENSIVE_MOVE:
    // ((2,9), TypeOfThreat::FiveTake, vec![(0,9),(0,6),(0,8),(0,10)])
    #[test]
