...
//        Ok(_) => match usize::from_str(&entree.trim()) {
//            Ok(nombre) => {
//                if nombre == 1 || nombre == 2 || nombre == 0 {
//                    Ok(nombre)
//                } else {
//                    Err("Wrong number entered")
//                }
//            }
//            Err(_) => Err("Error while parsing data"),
//        },
//        _ => Err("Error during the retrieval of the writing"),
//    }
//}
...
//    let enum_types: [game_class::TypeOfParty; 4] = [
//        game_class::TypeOfParty::Standard,
//        game_class::TypeOfParty::Pro,
//        game_class::TypeOfParty::Swap,
//        game_class::TypeOfParty::Swap2,
//    ];
