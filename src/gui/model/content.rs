...
impl Content {
    ...
    pub fn new() -> Content {
        ...
        let nbr_player: Label = Label::new(2.to_string().as_str());
        ...
        let gamerule: Label = Label::new("Classic");
        ...
        let gamerule1: Button = Button::new_with_label("gamerule1");
        let gamerule2: Button = Button::new_with_label("gamerule2");
        let gamerule3: Button = Button::new_with_label("gamerule3");
        let gamerule4: Button = Button::new_with_label("gamerule4");
